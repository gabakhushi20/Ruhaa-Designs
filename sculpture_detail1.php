...
<body>
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb py-2">
            ...
            <li class="breadcrumb-item">
                <a href="sculpture_list.html">Sculptures</a>
            </li>
    ...
    <div id="property-images" class="carousel slide" data-ride="carousel">
        ...
        <div class="container">
            <img class="image" src="./img/S1.jpg" />
            <div class="lens"></div>
    ...
    <div class="property-summary page-container">
        ...
        <div class="detail-container">
            <div class="property-name">Pottery Women</div>
            <div class="property-address">Women Gracefully shaping the utensil</div>
