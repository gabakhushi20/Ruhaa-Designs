...
<body>
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb py-2">
            ...
            <li class="breadcrumb-item">
                <a href="painting_list.html">Digital Art</a>
            </li>
    ...
    <div id="property-images" class="carousel slide" data-ride="carousel">
        ...
        <div class="container">
            <img class="image" src="./img/D3.jpg" />
            <div class="lens"></div>
    ...
    <div class="property-summary page-container">
        ...
        <div class="detail-container">
            <div class="property-name">Enchanting Illustration</div>
            <div class="property-address">Folk lore of Japanese Kami and Yokai.</div>
            ...
            <div class="row justify-content-between">
                <div class="col-md-auto">
                    <div class="amenity-container">
                        <span>Size: 12in x 9in</span>
                    </div>
                    <div class="amenity-container">
                        <span>Surface: Paper</span>
                    </div>
                    <div class="amenity-container">
                        <img src="img/icon1.jpg"/>
                        <span>Artist Sign and Certificate Provided</span>
                    </div>
                    <div class="amenity-container">
                ...
                <div class="col-md-auto">
                    <div class="amenity-container">
                        <span>Art Work: Original</span>
                    </div>
                    <div class="amenity-container">
                        <span>Created: 2023</span>
                    </div>
                    <div class="amenity-container">
                        <span>Quality: Mueseum quality-100% Hand painted</span>
                    </div>
                    <div class="amenity-container">
                        <span>To be delivered as: rolled</span>
                    </div>
                    <div class="amenity-container">
                        <span>Medium: Charcoal</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="property-about page-container">
        <h1>About the Painting</h1>
        <p>Expelling the shading evacuates the predispositions that our shading vision framework adds to how we see the picture. Painting in highly contrasting is incredible as it makes you focus on components, for example, arrangement, esteem, lighting, and frame. Obviously, shading is an essential stride. However, the advantage of high contrast is that you can concentrate on the picture overall. Black and White is regularly viewed as more immortal and modern than colored images or paintings. The purpose for it is that they associate with more exquisite time.</p>
    </div>

    <div class="property-rating">
        <div class="page-container">
            <h1>Painting Rating</h1>
            <div class="row align-items-center justify-content-between">
                <div class="col-md-6">
                    <div class="rating-criteria row">
                        <div class="col-6">
                            <span class="rating-criteria-text">Color Quality</span>
                        </div>
                    ...
                    <div class="rating-criteria row">
                        <div class="col-6">
                            <span class="rating-criteria-text">Print Quality</span>
                        </div>
                    ...
                    <div class="rating-criteria row">
                        <div class="col-6">
                            <span class="rating-criteria-text">Canvas Quality</span>
                        </div>
    ...
    <div class="property-testimonials page-container">
        ...
        <div class="testimonial-block">
            ...
            <div class="testimonial-text">
                ...
                <p>Beautifully hand painted and looks amazing on my wall.</p>
            </div>
            <div class="testimonial-name">- Ashutosh Gowariker</div>
        </div>
        <div class="testimonial-block">
            <div class="testimonial-image-container">
                <img class="testimonial-img" src="img/women.jpg">
            </div>
            <div class="testimonial-text">
                <i class="fa fa-quote-left" aria-hidden="true"></i>
                <p>Fantastic painting,I am totally mesmerized with it.</p>
            </div>
            <div class="testimonial-name">- Ellena Swan</div>
        </div>
    </div>
    ...
    <div class="footer">
        <div class="page-container footer-container">
            ...
            <div class="footer-copyright">© 2020 Copyright Muskan Gaba </div>
        </div>
    </div>
